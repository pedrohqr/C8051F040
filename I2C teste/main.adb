...
F:G$esc_eeprom$0$0({2}DF,SI:S),C,0,0,0,0,0
F:G$le_eeprom$0$0({2}DF,SI:S),C,0,0,0,0,0
F:G$Timer4_ISR$0$0({2}DF,SV:S),C,0,0,1,16,0
F:G$BotaoP0_2$0$0({2}DF,SV:S),C,0,0,1,0,0
...
S:Lmain.esc_LCD$dado$1$17({1}SC:U),R,0,0,[r7]
S:Lmain.esc_LCD$aux$1$18({1}SC:U),R,0,0,[r6]
S:Lmain.le_glcd$byte$1$26({1}SC:U),R,0,0,[r7]
S:Lmain.esc_glcd$byte$1$27({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$29({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$31({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$34({2}SI:S),R,0,0,[r6,r7]
S:Lmain.limpa_glcd$j$1$34({2}SI:S),R,0,0,[r4,r5]
S:Lmain.putchar$c$1$37({1}SC:U),R,0,0,[r7]
S:Lmain.esc_eeprom$end$1$81({1}SC:U),E,0,0
S:Lmain.esc_eeprom$dado$1$81({1}SC:U),E,0,0
S:Lmain.esc_eeprom$end_disp$1$81({1}SC:U),R,0,0,[r7]
S:Lmain.esc_eeprom$status$1$82({1}SC:U),R,0,0,[r7]
S:Lmain.le_eeprom$end$1$83({1}SC:U),E,0,0
S:Lmain.le_eeprom$end_disp$1$83({1}SC:U),R,0,0,[r7]
S:Lmain.le_eeprom$status$1$84({1}SC:U),R,0,0,[r7]
S:Lmain.BotaoP0_2$f$1$87({4}SF:S),R,0,0,[]
S:Lmain.main$f$1$89({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:Lmain.esc_LCD$nb$1$17({1}SB0$1:U),H,0,0
S:Lmain.esc_LCD$cd$1$17({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cd$1$25({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$25({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$27({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$27({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$29({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$31({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$33({1}SB0$1:U),H,0,0
S:Lmain.putchar$lado$1$38({1}SB0$1:U),H,0,0
S:Lmain.esc_byte_cntr$P2_3$1$75({1}SB0$1:U),H,0,0
...
S:G$BotaoP0_2$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$fonte$0$0({480}DA96d,DA5d,SC:U),D,0,0
S:G$pos$0$0({1}SC:U),D,0,0
S:Fmain$__str_0$0$0({17}DA17d,SC:S),D,0,0
S:Fmain$__str_1$0$0({14}DA14d,SC:S),D,0,0

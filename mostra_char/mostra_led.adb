...
F:G$copyP0_P6$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$desloca_texto$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
T:Fmostra_led$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:Fmostra_led$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:G$PAux$0$0({1}SC:U),E,0,0
S:Lmostra_led.desloca_texto$t$1$33({2}SI:U),E,0,0
S:Lmostra_led.desloca_texto$text$1$33({3}DG,SC:U),E,0,0
S:Lmostra_led.desloca_texto$i$1$34({2}SI:U),E,0,0
S:Lmostra_led.desloca_texto$j$1$34({2}SI:U),E,0,0
S:Lmostra_led.desloca_texto$len$1$34({2}SI:U),R,0,0,[r3,r4]
S:Lmostra_led.desloca_texto$posP7Shown$1$34({2}SI:U),R,0,0,[r1,r2]
S:Lmostra_led.main$i$1$39({2}SI:S),E,0,0
...
S:G$copyP0_P6$0$0({2}DF,SV:S),C,0,0
S:G$desloca_texto$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$mat$0$0({176}DA44d,DA4d,SC:U),D,0,0
S:Fmostra_led$__str_0$0$0({6}DA6d,SC:S),D,0,0

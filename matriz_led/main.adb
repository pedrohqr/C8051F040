...
S:Lmain.draw$i$1$12({2}SI:U),E,0,0
S:Lmain.draw$m$1$12({2}DC,DA4d,SC:U),R,0,0,[r6,r7]
S:Lmain.main$i$1$15({2}SI:S),R,0,0,[r6,r7]
...
S:Lmain.main$mat$1$15({172}DA43d,DA4d,SC:U),D,0,0

...
F:G$toca$0$0({2}DF,SV:S),C,0,0,1,0,0
...
S:Fbuzzer$carac_esc$0$0({2}SI:S),E,0,0
S:Fbuzzer$pag_esc$0$0({2}SI:S),E,0,0
S:Lbuzzer.esc_LCD$dado$1$18({1}SC:U),R,0,0,[r7]
S:Lbuzzer.esc_LCD$aux$1$19({1}SC:U),R,0,0,[r6]
S:Lbuzzer.le_glcd$byte$1$27({1}SC:U),R,0,0,[r7]
S:Lbuzzer.esc_glcd$byte$1$28({1}SC:U),R,0,0,[r7]
S:Lbuzzer.conf_Y$y$1$30({1}SC:U),R,0,0,[r7]
S:Lbuzzer.conf_pag$pag$1$32({1}SC:U),R,0,0,[r7]
S:Lbuzzer.limpa_glcd$i$1$35({2}SI:S),R,0,0,[r6,r7]
S:Lbuzzer.limpa_glcd$j$1$35({2}SI:S),R,0,0,[r4,r5]
S:Lbuzzer.esc_LCD$nb$1$18({1}SB0$1:U),H,0,0
S:Lbuzzer.esc_LCD$cd$1$18({1}SB0$1:U),H,0,0
S:Lbuzzer.le_glcd$cd$1$26({1}SB0$1:U),H,0,0
S:Lbuzzer.le_glcd$cs$1$26({1}SB0$1:U),H,0,0
S:Lbuzzer.esc_glcd$cd$1$28({1}SB0$1:U),H,0,0
S:Lbuzzer.esc_glcd$cs$1$28({1}SB0$1:U),H,0,0
S:Lbuzzer.conf_Y$cs$1$30({1}SB0$1:U),H,0,0
S:Lbuzzer.conf_pag$cs$1$32({1}SB0$1:U),H,0,0
S:Lbuzzer.limpa_glcd$cs$1$34({1}SB0$1:U),H,0,0

...
S:Lmain.le_glcd$byte$1$37({1}SC:U),R,0,0,[r7]
S:Lmain.esc_glcd$byte$1$38({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$41({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$43({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$46({2}SI:S),R,0,0,[r6,r7]
S:Lmain.limpa_glcd$j$1$46({2}SI:S),R,0,0,[r4,r5]
S:Lmain.putchar$c$1$48({1}SC:U),R,0,0,[r7]
S:Lmain.esc_LCD$nb$1$15({1}SB0$1:U),H,0,0
S:Lmain.esc_LCD$cd$1$15({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cd$1$36({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$36({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$38({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$38({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$41({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$43({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$45({1}SB0$1:U),H,0,0

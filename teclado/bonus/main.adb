...
F:G$clear$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$esc_LCD$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$Ini_LCDan$0$0({2}DF,SV:S),C,0,0,0,0,0
...
F:G$draw$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$obstaculo$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$limpa_frame$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$ISR_ext1$0$0({2}DF,SV:S),C,0,0,1,2,0
F:G$ISR_tc2$0$0({2}DF,SV:S),C,0,0,1,5,0
F:G$ISR_tc2$0$0({2}DF,SV:S),C,0,0,1,5,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
T:Fmain$TObstaculo[({0}S:S$X$0$0({1}SC:U),Z,0,0)({1}S:S$Y$0$0({1}SC:U),Z,0,0)]
...
T:Fmain$TCapivara[({0}S:S$X$0$0({1}SC:U),Z,0,0)({1}S:S$Y$0$0({1}SC:U),Z,0,0)]
S:Fmain$carac_esc$0$0({2}SI:S),E,0,0
S:Fmain$pag_esc$0$0({2}SI:S),E,0,0
S:Lmain.esc_LCD$dado$1$15({1}SC:U),R,0,0,[r7]
S:Lmain.esc_LCD$aux$1$16({1}SC:U),R,0,0,[r6]
S:Lmain.le_glcd$byte$1$24({1}SC:U),R,0,0,[r7]
S:Lmain.esc_glcd$byte$1$25({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$27({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$29({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$32({2}SI:S),R,0,0,[r6,r7]
S:Lmain.limpa_glcd$j$1$32({2}SI:S),R,0,0,[r4,r5]
S:Lmain.putchar$c$1$35({1}SC:U),R,0,0,[r7]
S:G$capi$0$0({2}STTCapivara:S),E,0,0
S:G$obs$0$0({2}STTObstaculo:S),E,0,0
S:Lmain.draw$Y$1$53({1}SC:U),E,0,0
S:Lmain.draw$i$1$53({1}SC:U),E,0,0
S:Lmain.draw$X$1$53({1}SC:U),R,0,0,[r7]
S:Lmain.draw$col$1$54({2}SI:S),E,0,0
S:Lmain.draw$_pag$1$54({1}SC:U),E,0,0
S:Lmain.draw$_pos$1$54({1}SC:U),E,0,0
S:Lmain.draw$posX$1$54({1}SC:U),E,0,0
S:Lmain.draw$aux$1$54({1}SC:U),R,0,0,[]
S:Lmain.obstaculo$col$1$59({2}SI:S),R,0,0,[r6,r7]
S:Lmain.obstaculo$_lado$1$59({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_frame$i$1$61({2}SI:S),R,0,0,[r6,r7]
S:Lmain.limpa_frame$j$1$61({2}SI:S),R,0,0,[r4,r5]
S:Lmain.ISR_ext1$i$1$65({2}SI:S),R,0,0,[r6,r7]
S:Lmain.ISR_tc2$ni$1$69({1}SC:U),E,0,0
S:Lmain.esc_LCD$nb$1$15({1}SB0$1:U),H,0,0
S:Lmain.esc_LCD$cd$1$15({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cd$1$23({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$23({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$25({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$25({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$27({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$29({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$31({1}SB0$1:U),H,0,0
S:Lmain.putchar$lado$1$36({1}SB0$1:U),H,0,0
S:Lmain.obstaculo$sloc0$1$0({1}SB0$1:U),H,0,0
...
S:G$clear$0$0({2}DF,SV:S),C,0,0
S:G$esc_LCD$0$0({2}DF,SV:S),C,0,0
S:G$Ini_LCDan$0$0({2}DF,SV:S),C,0,0
...
S:G$draw$0$0({2}DF,SV:S),C,0,0
S:G$obstaculo$0$0({2}DF,SV:S),C,0,0
S:G$limpa_frame$0$0({2}DF,SV:S),C,0,0
S:G$ISR_ext1$0$0({2}DF,SV:S),C,0,0
S:G$ISR_tc2$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$fonte$0$0({480}DA96d,DA5d,SC:U),D,0,0
S:G$cap_fonte$0$0({120}DA3d,DA40d,SC:U),D,0,0
S:G$obs_fonte$0$0({8}DA1d,DA8d,SC:U),D,0,0
S:Fmain$__str_0$0$0({18}DA18d,SC:S),D,0,0

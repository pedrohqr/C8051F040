...
F:G$le_tec$0$0({2}DF,SC:U),C,0,0,0,0,0
...
S:G$botao$0$0({1}SC:U),E,0,0
S:Lmain.putchar$c$1$48({1}SC:U),R,0,0,[r7]
...
S:Lmain.putchar$lado$1$49({1}SB0$1:U),H,0,0
...
S:G$le_tec$0$0({2}DF,SC:U),C,0,0

...
F:G$int_uart$0$0({2}DF,SV:S),C,0,0,1,4,0
...
S:Lmain.esc_LCD$dado$1$21({1}SC:U),R,0,0,[r7]
S:Lmain.esc_LCD$aux$1$22({1}SC:U),R,0,0,[r6]
S:Lmain.le_glcd$byte$1$30({1}SC:U),R,0,0,[r7]
S:Lmain.esc_glcd$byte$1$31({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$33({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$35({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$38({2}SI:S),R,0,0,[r6,r7]
S:Lmain.limpa_glcd$j$1$38({2}SI:S),R,0,0,[r4,r5]
S:G$byte_serial$0$0({1}SC:U),E,0,0
S:Lmain.esc_LCD$nb$1$21({1}SB0$1:U),H,0,0
S:Lmain.esc_LCD$cd$1$21({1}SB0$1:U),H,0,0
...
S:G$int_uart$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$fonte$0$0({480}DA96d,DA5d,SC:U),D,0,0
S:Fmain$__str_0$0$0({27}DA27d,SC:S),D,0,0
S:Fmain$__str_1$0$0({72}DA72d,SC:S),D,0,0
S:Fmain$__str_2$0$0({13}DA13d,SC:S),D,0,0
S:Fmain$__str_3$0$0({11}DA11d,SC:S),D,0,0

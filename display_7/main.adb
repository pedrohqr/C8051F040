...
F:G$sync_disp$0$0({2}DF,SV:S),C,0,0,1,5,0
F:G$sync_disp$0$0({2}DF,SV:S),C,0,0,1,5,0
...
S:G$alg_E$0$0({1}SC:U),E,0,0
S:G$alg_D$0$0({1}SC:U),E,0,0
S:Lmain.esc_disp7s$n$1$12({2}SI:U),R,0,0,[r6,r7]
S:Lmain.sync_disp$cont_algs$1$15({1}SC:U),E,0,0
S:Lmain.main$i$1$19({2}SI:S),R,0,0,[r6,r7]
...
S:G$sync_disp$0$0({2}DF,SV:S),C,0,0

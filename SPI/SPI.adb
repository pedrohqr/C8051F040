...
T:FSPI$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:FSPI$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:FSPI$carac_esc$0$0({2}SI:S),E,0,0
S:FSPI$pag_esc$0$0({2}SI:S),E,0,0
S:LSPI.esc_LCD$dado$1$22({1}SC:U),R,0,0,[r7]
S:LSPI.esc_LCD$aux$1$23({1}SC:U),R,0,0,[r6]
S:LSPI.le_glcd$byte$1$31({1}SC:U),R,0,0,[r7]
S:LSPI.esc_glcd$byte$1$32({1}SC:U),R,0,0,[r7]
S:LSPI.conf_Y$y$1$34({1}SC:U),R,0,0,[r7]
S:LSPI.conf_pag$pag$1$36({1}SC:U),R,0,0,[r7]
S:LSPI.limpa_glcd$i$1$39({2}SI:S),R,0,0,[r6,r7]
S:LSPI.limpa_glcd$j$1$39({2}SI:S),R,0,0,[r4,r5]
S:LSPI.putchar$c$1$42({1}SC:U),R,0,0,[r7]
S:LSPI.main$i$1$65({2}SI:U),R,0,0,[r6,r7]
S:LSPI.main$dado$1$65({1}SC:U),R,0,0,[]
S:LSPI.esc_LCD$nb$1$22({1}SB0$1:U),H,0,0
S:LSPI.esc_LCD$cd$1$22({1}SB0$1:U),H,0,0
S:LSPI.le_glcd$cd$1$30({1}SB0$1:U),H,0,0
S:LSPI.le_glcd$cs$1$30({1}SB0$1:U),H,0,0
S:LSPI.esc_glcd$cd$1$32({1}SB0$1:U),H,0,0
S:LSPI.esc_glcd$cs$1$32({1}SB0$1:U),H,0,0
S:LSPI.conf_Y$cs$1$34({1}SB0$1:U),H,0,0
S:LSPI.conf_pag$cs$1$36({1}SB0$1:U),H,0,0
S:LSPI.limpa_glcd$cs$1$38({1}SB0$1:U),H,0,0
S:LSPI.putchar$lado$1$43({1}SB0$1:U),H,0,0
...
S:FSPI$__str_0$0$0({25}DA25d,SC:S),D,0,0
S:FSPI$__str_1$0$0({14}DA14d,SC:S),D,0,0
S:FSPI$__str_2$0$0({13}DA13d,SC:S),D,0,0
S:FSPI$__str_3$0$0({10}DA10d,SC:S),D,0,0

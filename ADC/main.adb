...
S:Lmain.esc_LCD$dado$1$20({1}SC:U),R,0,0,[r7]
S:Lmain.esc_LCD$aux$1$21({1}SC:U),R,0,0,[r6]
S:Lmain.le_glcd$byte$1$29({1}SC:U),R,0,0,[r7]
S:Lmain.esc_glcd$byte$1$30({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$32({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$34({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$37({2}SI:S),R,0,0,[r6,r7]
S:Lmain.limpa_glcd$j$1$37({2}SI:S),R,0,0,[r4,r5]
S:Lmain.putchar$c$1$40({1}SC:U),R,0,0,[r7]
S:Lmain.main$tensao$1$61({4}SF:S),R,0,0,[r2,r3,r4,r5]
S:Lmain.main$temp$1$61({4}SF:S),E,0,0
S:Lmain.main$lado$1$61({2}SI:U),R,0,0,[r6,r7]
S:Lmain.esc_LCD$nb$1$20({1}SB0$1:U),H,0,0
S:Lmain.esc_LCD$cd$1$20({1}SB0$1:U),H,0,0
...
S:Lmain.putchar$lado$1$41({1}SB0$1:U),H,0,0

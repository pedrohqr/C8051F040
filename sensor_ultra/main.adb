...
F:G$int_tcl$0$0({2}DF,SV:S),C,0,0,1,3,0
...
S:Lmain.esc_LCD$dado$1$16({1}SC:U),R,0,0,[r7]
S:Lmain.esc_LCD$aux$1$17({1}SC:U),R,0,0,[r6]
S:Lmain.le_glcd$byte$1$25({1}SC:U),R,0,0,[r7]
S:Lmain.esc_glcd$byte$1$26({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$28({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$30({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$i$1$33({2}SI:S),R,0,0,[r6,r7]
S:Lmain.limpa_glcd$j$1$33({2}SI:S),R,0,0,[r4,r5]
S:Lmain.putchar$c$1$36({1}SC:U),R,0,0,[r7]
S:G$cont_t$0$0({4}SF:S),E,0,0
S:Lmain.le_pulso$th_tl$1$55({2}SI:U),R,0,0,[]
S:Lmain.le_hcsr04$lp$1$59({2}SI:U),R,0,0,[]
S:Lmain.main$p$1$61({2}SI:U),R,0,0,[r6,r7]
S:Lmain.esc_LCD$nb$1$16({1}SB0$1:U),H,0,0
S:Lmain.esc_LCD$cd$1$16({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cd$1$24({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$24({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$26({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$26({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$28({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$30({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$32({1}SB0$1:U),H,0,0
S:Lmain.putchar$lado$1$37({1}SB0$1:U),H,0,0
